In Git, "master" is a common naming convention for a branch. In Git, when a new repository is created, it's assigned the master by deault. If for example, a user
